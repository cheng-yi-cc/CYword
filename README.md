...
当前 0.4.2 版提供大学英语六级词书，包含 5166 个唯一单词，学习时从官网词书接口加载。排课结合熟词拓扑排序优化，支持巧记中关联词悬浮速查与计划全日程自由点选。计划按“学习 3 天、集中复习 1 天”循环，共 40 天：30 个学习日、10 个复习日。复习日覆盖此前学过的全部唯一单词，并默认跳过“已掌握”。
