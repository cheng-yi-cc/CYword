...
0.2.0 版内置大学英语六级词书，包含 5166 个唯一单词。计划按“学习 3 天、集中复习 1 天”循环，共 40 天：30 个学习日、10 个复习日。复习日覆盖此前学过的全部唯一单词，并默认跳过“已掌握”。
...
安装程序输出到 `release/CYword-Setup-<version>.exe`。Windows 可能因安装包未签名而显示 SmartScreen 提示。
